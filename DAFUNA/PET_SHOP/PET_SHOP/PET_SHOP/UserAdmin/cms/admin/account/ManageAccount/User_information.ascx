<%@ Control Language="C#" AutoEventWireup="true" CodeFile="User_information.ascx.cs" Inherits="UserAdmin_cms_admin_account_ManageAccount_User_information" %>
<style>
    .thongTin{
        padding: 20px 0;
    }
...
">
  ...
  <div class="wrapper">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap"> 
            <asp:Label  CssClass="input" ID="txtSodienthoai" runat="server" required="required" ></asp:Label>
        ...
        <div class="oNhap"> 
            <asp:Label  CssClass="input" ID="txtDiaChi" runat="server" required="required" ></asp:Label>
