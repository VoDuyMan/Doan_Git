<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Contact_Details.ascx.cs" Inherits="UserAdmin_cms_admin_account_ManageContact_Contact_Details" %>
<style>
    .thongTin{
        padding: 20px 0;
    }
...
<div class="FormAdd">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:Label CssClass="input" ID="TenUser" runat="server"></asp:Label>
        </div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">Email: </div>
        <div class="oNhap">
            <asp:Label CssClass="input" ID="txtEmail" runat="server" required="required" ></asp:Label>
        </div>
    </div>
    <div class="AnhDong" style="
    position: absolute;
    float: right;
...
">
  ...
  <div class="wrapper">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap"> 
            <asp:Label  CssClass="input" ID="txtNoiDung" runat="server" required="required" ></asp:Label>

    </div>
        </div>
        <div class="thongTin">
        <div class="tenTruong">Tài khoản</div>
        <div class="oNhap"> 
            <asp:Label  CssClass="input" ID="txtTaiKhoan" runat="server" required="required" ></asp:Label>
