<%@ Control Language="C#" AutoEventWireup="true" CodeFile="cart.ascx.cs" Inherits="UserUI_cart" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <div>
        <div class="banner_sp">
            <ul>
                ...
                <li><a href="TrangChu.aspx">Trang chủ </a><i class="ti-angle-right"></i><a href="GioHang.aspx"
                        style="color: #C49A6C;"> Giỏ hàng</a></li>
            </ul>
        </div>
    </div>
    <!-- Giỏ hàng -->
  ...
  <div class="modal js-modal" id="show-modal">
    <div class="modal-container">
        <header class="modal-header">
            ...
            Sản phẩm vừa được thêm giỏ hàng
        </header>
                        ...
                        <div style="display:flex; justify-content:center; align-items:center">
                            <div class="name-product">
                                <div class="modal-close">
                                    <asp:Button CssClass="close" runat="server" CommandName="DeleteItem" CommandArgument='<%# Eval("id") %>' Text="X" />
                                </div>
                                <div class="image">
                                    <img src='./img/<%# Eval("thumbnail") %>' alt="">
                                    <a href="ProductDetail.aspx?id=<%# Eval("id") %>"><%# Eval("title") %></a>
                                </div>
                            </div>
                            <div class="soluong modal-soluong">
                                <input type="text" id="amount" name="amount" value='<%# Eval("num") %>'>
                            </div>
                            <h5>$<%# Eval("TotalPrice") %></h5>
                        </div>
                    </ItemTemplate>
                    <FooterTemplate>
        ...
        <div class="modal-tong">
            ...
            <ul>
                ...
                <li style="font-size: 30px; color: #f7941d;font-weight: 700;">$<%= GetTotalPrice() %></li>
            </ul>
        </div>
        <div class="bnts">
            <asp:Button CssClass="btn-buy" ID="btnCheckout" runat="server" Text="Thanh toán" OnClick="btnCheckout_Click" />
        </div>
         <div Class="btn-buy thongtin" style=" background: none; ; display: block;width: 230px;margin-top:-65px;margin-left:35px">
              <a href="DonHang.aspx">Thông tin đơn hàng</a>
          </div>
    </div>
</div>
    <!-- footer  -->
