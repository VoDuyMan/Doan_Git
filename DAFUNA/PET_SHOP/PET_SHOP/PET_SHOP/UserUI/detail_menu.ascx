<%@ Control Language="C#" AutoEventWireup="true" CodeFile="detail_menu.ascx.cs" Inherits="UserUI_detail_menu" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div>
    <div class="banner_sp">
        <ul>
            ...
            <li><a href="TrangChu.aspx">Trang chủ </a><i class="ti-angle-right"></i><a  href="SanPham.aspx" style="color: #C49A6C;"> Sản phẩm</a></li>
        </ul>
    </div>
                ...
                <section>
                  <%for (int i = 0; i < ListSPs.Count; i++)
                    ...
                    <div class="product" style="width: 24%;  ">
                        <a href='<%="CTSP.aspx?id="+ ListSPs[i].id%>'>
                            <div style="width:100%; height: 300px;">

                            <img style="width:100%; height:100%; display:block;" class="img" src='<%="./img/" + ListSPs[i].thumbnail%>' alt="Sản phẩm 1">
                            </div>
                            <h2 style=" overflow: hidden; padding: 0 20px; text-overflow: ellipsis; white-space: nowrap;"><%=ListSPs[i].title%></h2>
                            <p>Giá: $<%=ListSPs[i].price%></p>
                        </a>
                    </div>
        <%} %>
                </section>
